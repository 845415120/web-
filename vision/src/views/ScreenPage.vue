<template>
  <div class="screen-container" :style="containerStyle">
    <header class="screen-header">
      ...
      <span class="title">智慧城市大数据可视化平台</span>
    ...
    <div class="screen-body">
      <section class="screen-left">
        ...
        <div id="left-bottom" :class="[fullScreenStatus.traffic ? 'fullscreen' : '']">
          <Traffic ref="traffic"></Traffic>
          <div class="resize">
            <!-- icon-compress-alt -->
            <span @click="changeSize('traffic')"  :class="['iconfont', fullScreenStatus.traffic ? 'icon-compress-alt' : 'icon-expand-alt']"></span>
          </div>
        </div>
      </section>
